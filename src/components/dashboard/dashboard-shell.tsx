...
import { AppModals } from "@/components/shared/app-modals"; // Ensure AppModals is imported
...
export function DashboardShell({ children }: Props) {
  ...
  const setProfileOpen = useUIStore((s) => s.setProfileOpen); // Pull setProfileOpen from store
  ...
  return (
    <main className="min-h-screen bg-[#020817] text-white">
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#020817]/90 backdrop-blur-2xl">
        <div className="mx-auto flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {/* Wire up the Profile button to open the AppModals profile view */}
            <button 
      ...
      {/* Global Modals for App Settings (Profile/Backup) */}
      <AppModals />
